...
export default async function Navbar(): Promise<JSX.Element> {
  ...
  return (
    <header className="h-16  w-full md:w-[calc(100%-16rem)] fixed top-0 left-0 md:left-64 flex items-center justify-between px-6 bg-[#12161F] md:border-b md:border-[#2A2F3A] shrink-0">
